...
- **docs/js/asset-maps.js** - Team logo and golfer headshot URL mappings (football, esports CS2)
...
│   ├── asset-maps.js       # Team logos + golfer headshot URLs (football + CS2 esports)
