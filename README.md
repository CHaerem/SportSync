...
| Siste 7 dager | topp 98% · snitt 51% | 18t i sparemodus |

<sub>Oppdatert 2026-07-23 15:27 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
