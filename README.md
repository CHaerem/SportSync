...
|---|---|---|
| Uke (7d) | **23%** 🟢 | ↑ +18pp siste 24t · nullstilles 2026-07-22 |
| Sesjon (5t) | 2% | nullstilles 02:10 UTC |
| Siste 7 dager | topp 100% · snitt 37% | 12t i sparemodus |

<sub>Oppdatert 2026-07-16 23:13 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
