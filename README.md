...
|---|---|---|
| Uke (7d) | **79%** 🟡 | ↑ +36pp siste 24t · nullstilles 2026-07-27 |
| Sesjon (5t) | 75% | nullstilles 23:40 UTC |
| Siste 7 dager | topp 98% · snitt 47% | 15t i sparemodus |

<sub>Oppdatert 2026-07-22 22:27 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
