...
| Siste 7 dager | topp 98% · snitt 52% | 19t i sparemodus |

<sub>Oppdatert 2026-07-23 17:50 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
