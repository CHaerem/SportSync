...
|---|---|---|
| Uke (7d) | **17%** 🟢 | ↑ +5pp siste 24t · nullstilles 2026-07-15 |
| Sesjon (5t) | 2% | nullstilles 20:00 UTC |
| Siste 7 dager | topp 95% · snitt 52% | 15t i sparemodus |

<sub>Oppdatert 2026-07-10 17:12 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
