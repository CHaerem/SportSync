...
|---|---|---|
| Uke (7d) | **100%** 🔴 | ↑ +17pp siste 24t · nullstilles 2026-07-27 |
| Sesjon (5t) | 5% | nullstilles 19:10 UTC |
| Siste 7 dager | topp 100% · snitt 58% | 26t i sparemodus |

<sub>Oppdatert 2026-07-24 15:10 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
