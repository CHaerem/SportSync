...
|---|---|---|
| Uke (7d) | **43%** 🟢 | ↑ +31pp siste 24t · nullstilles 2026-07-27 |
| Sesjon (5t) | 51% | nullstilles 23:40 UTC |
| Siste 7 dager | topp 100% · snitt 47% | 20t i sparemodus |

<sub>Oppdatert 2026-07-21 22:14 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
