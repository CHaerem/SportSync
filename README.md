...
|---|---|---|
| Uke (7d) | **23%** 🟢 | ↑ +3pp siste 24t · nullstilles 2026-07-15 |
| Sesjon (5t) | 0% | nullstilles 14:40 UTC |
| Siste 7 dager | topp 95% · snitt 43% | 15t i sparemodus |

<sub>Oppdatert 2026-07-12 10:02 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
