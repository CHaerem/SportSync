...
|---|---|---|
| Uke (7d) | **77%** 🟡 | ↑ +6pp siste 24t · nullstilles 2026-07-08 |
| Sesjon (5t) | 0% | nullstilles 02:00 UTC |
| Siste 7 dager | topp 77% · snitt 72% | 3t i sparemodus |

<sub>Oppdatert 2026-07-06 21:03 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
