...
|---|---|---|
| Uke (7d) | **83%** 🟡 | ↑ +25pp siste 24t · nullstilles 2026-07-27 |
| Sesjon (5t) | 3% | nullstilles 13:50 UTC |
| Siste 7 dager | topp 98% · snitt 50% | 17t i sparemodus |

<sub>Oppdatert 2026-07-23 12:51 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
