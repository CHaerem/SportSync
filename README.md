...
|---|---|---|
| Uke (7d) | **91%** 🔴 | ↑ +38pp siste 24t · nullstilles 2026-07-15 |
| Sesjon (5t) | 43% | nullstilles 23:40 UTC |
| Siste 7 dager | topp 95% · snitt 36% | 11t i sparemodus |

<sub>Oppdatert 2026-07-14 21:17 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
