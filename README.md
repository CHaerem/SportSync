...
|---|---|---|
| Uke (7d) | **23%** 🟢 | ↑ +23pp siste 24t · nullstilles 2026-07-22 |
| Sesjon (5t) | 15% | nullstilles 21:10 UTC |
| Siste 7 dager | topp 100% · snitt 36% | 12t i sparemodus |

<sub>Oppdatert 2026-07-16 18:34 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
