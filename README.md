...
|---|---|---|
| Uke (7d) | **22%** 🟢 | ↑ +4pp siste 24t · nullstilles 2026-07-15 |
| Sesjon (5t) | 5% | nullstilles 00:30 UTC |
| Siste 7 dager | topp 95% · snitt 44% | 15t i sparemodus |

<sub>Oppdatert 2026-07-11 23:13 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
