...
|---|---|---|
| Uke (7d) | **56%** 🟢 | ↑ +36pp siste 24t · nullstilles 2026-07-27 |
| Sesjon (5t) | 4% | nullstilles 13:40 UTC |
| Siste 7 dager | topp 100% · snitt 45% | 17t i sparemodus |

<sub>Oppdatert 2026-07-22 10:35 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
