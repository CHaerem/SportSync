...
| Sesjon (5t) | 6% | nullstilles 23:50 UTC |
| Siste 7 dager | topp 100% · snitt 57% | 24t i sparemodus |

<sub>Oppdatert 2026-07-19 21:09 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
