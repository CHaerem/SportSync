...
|---|---|---|
| Uke (7d) | **17%** 🟢 | ↑ +15pp siste 24t · nullstilles 2026-07-15 |
| Sesjon (5t) | 0% | nullstilles 01:40 UTC |
| Siste 7 dager | topp 95% · snitt 50% | 15t i sparemodus |

<sub>Oppdatert 2026-07-10 20:45 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
