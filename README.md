...
|---|---|---|
| Uke (7d) | **17%** 🟢 | ↑ +16pp siste 24t · nullstilles 2026-07-15 |
| Sesjon (5t) | 4% | nullstilles 20:00 UTC |
| Siste 7 dager | topp 95% · snitt 51% | 15t i sparemodus |

<sub>Oppdatert 2026-07-10 18:49 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
