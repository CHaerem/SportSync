...
|---|---|---|
| Uke (7d) | **4%** 🟢 | ↓ −86pp siste 24t · nullstilles 2026-07-22 |
| Sesjon (5t) | 33% | nullstilles 22:40 UTC |
| Siste 7 dager | topp 100% · snitt 36% | 11t i sparemodus |

<sub>Oppdatert 2026-07-15 21:17 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
