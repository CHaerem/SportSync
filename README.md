...
|---|---|---|
| Uke (7d) | **31%** 🟢 | ↑ +22pp siste 24t · nullstilles 2026-07-27 |
| Sesjon (5t) | 18% | nullstilles 18:40 UTC |
| Siste 7 dager | topp 100% · snitt 50% | 24t i sparemodus |

<sub>Oppdatert 2026-07-21 15:18 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
