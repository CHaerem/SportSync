...
|---|---|---|
| Uke (7d) | **52%** 🟢 | ↑ +28pp siste 24t · nullstilles 2026-07-15 |
| Sesjon (5t) | 4% | nullstilles 23:50 UTC |
| Siste 7 dager | topp 95% · snitt 35% | 13t i sparemodus |

<sub>Oppdatert 2026-07-13 19:52 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
