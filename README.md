...
|---|---|---|
| Uke (7d) | **48%** 🟢 | ↑ +25pp siste 24t · nullstilles 2026-07-22 |
| Sesjon (5t) | 0% | nullstilles 23:30 UTC |
| Siste 7 dager | topp 100% · snitt 39% | 12t i sparemodus |

<sub>Oppdatert 2026-07-17 19:35 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
