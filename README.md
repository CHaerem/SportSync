...
|---|---|---|
| Uke (7d) | **33%** 🟢 | ↑ +23pp siste 24t · nullstilles 2026-07-27 |
| Sesjon (5t) | 0% | nullstilles 23:40 UTC |
| Siste 7 dager | topp 100% · snitt 48% | 22t i sparemodus |

<sub>Oppdatert 2026-07-21 18:43 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
