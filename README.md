...
|---|---|---|
| Uke (7d) | **10%** 🟢 | ↑ +3pp siste 24t · nullstilles 2026-07-15 |
| Sesjon (5t) | 12% | nullstilles 14:50 UTC |
| Siste 7 dager | topp 95% · snitt 54% | 15t i sparemodus |

<sub>Oppdatert 2026-07-10 12:10 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
