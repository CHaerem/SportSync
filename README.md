...
|---|---|---|
| Uke (7d) | **95%** 🔴 | ↑ +9pp siste 24t · nullstilles 2026-07-08 |
| Sesjon (5t) | 2% | nullstilles 19:40 UTC |
| Siste 7 dager | topp 95% · snitt 80% | 15t i sparemodus |

<sub>Oppdatert 2026-07-08 15:37 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
