...
|---|---|---|
| Uke (7d) | **31%** 🟢 | ↑ +21pp siste 24t · nullstilles 2026-07-27 |
| Sesjon (5t) | 18% | nullstilles 18:40 UTC |
| Siste 7 dager | topp 100% · snitt 49% | 23t i sparemodus |

<sub>Oppdatert 2026-07-21 16:50 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
