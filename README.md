...
| Siste 7 dager | topp 95% · snitt 42% | 15t i sparemodus |

<sub>Oppdatert 2026-07-12 13:58 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
