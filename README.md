...
|---|---|---|
| Uke (7d) | **98%** 🔴 | ↑ +23pp siste 24t · nullstilles 2026-07-22 |
| Sesjon (5t) | 10% | nullstilles 23:50 UTC |
| Siste 7 dager | topp 100% · snitt 58% | 25t i sparemodus |

<sub>Oppdatert 2026-07-19 21:33 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
