...
|---|---|---|
| Uke (7d) | **23%** 🟢 | ↑ +17pp siste 24t · nullstilles 2026-07-27 |
| Sesjon (5t) | 33% | nullstilles 13:40 UTC |
| Siste 7 dager | topp 100% · snitt 50% | 25t i sparemodus |

<sub>Oppdatert 2026-07-21 12:46 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
