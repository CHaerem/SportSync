...
|---|---|---|
| Uke (7d) | **27%** 🟢 | ↑ +22pp siste 24t · nullstilles 2026-07-22 |
| Sesjon (5t) | 27% | nullstilles 08:30 UTC |
| Siste 7 dager | topp 100% · snitt 37% | 12t i sparemodus |

<sub>Oppdatert 2026-07-17 07:30 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
