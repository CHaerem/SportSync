...
| Siste 7 dager | topp 95% · snitt 45% | 15t i sparemodus |

<sub>Oppdatert 2026-07-11 21:09 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
