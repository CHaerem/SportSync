...
|---|---|---|
| Uke (7d) | **76%** 🟡 | ↑ +5pp siste 24t · nullstilles 2026-07-08 |
| Sesjon (5t) | 21% | nullstilles 20:50 UTC |
| Siste 7 dager | topp 76% · snitt 72% | 2t i sparemodus |

<sub>Oppdatert 2026-07-06 19:10 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
