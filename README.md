...
|---|---|---|
| Uke (7d) | **18%** 🟢 | ↑ +15pp siste 24t · nullstilles 2026-07-15 |
| Sesjon (5t) | 2% | nullstilles 01:40 UTC |
| Siste 7 dager | topp 95% · snitt 49% | 15t i sparemodus |

<sub>Oppdatert 2026-07-10 22:27 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
