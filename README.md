...
|---|---|---|
| Uke (7d) | **79%** 🟡 | ↑ +40pp siste 24t · nullstilles 2026-07-15 |
| Sesjon (5t) | 12% | nullstilles 18:30 UTC |
| Siste 7 dager | topp 95% · snitt 35% | 10t i sparemodus |

<sub>Oppdatert 2026-07-14 14:16 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
