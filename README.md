...
|---|---|---|
| Uke (7d) | **58%** 🟢 | ↑ +35pp siste 24t · nullstilles 2026-07-27 |
| Sesjon (5t) | 13% | nullstilles 13:40 UTC |
| Siste 7 dager | topp 100% · snitt 45% | 16t i sparemodus |

<sub>Oppdatert 2026-07-22 12:48 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
