...
//  fixture events; SportivistaJSONDateFormatTests.swift also proves it directly
...
final class EventDecodingTests: XCTestCase {
    private lazy var events: [Event] = try! SportivistaJSON.decoder.decode([Event].self, from: Fixture.data("events"))
