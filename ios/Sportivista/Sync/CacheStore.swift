...
//  App Group container (declared in Sportivista.entitlements /
//  SportivistaWidget.entitlements, see ios/README.md) so the widget extension can
...
//  piece of Sportivista-owned bookkeeping alongside them.
//
...
final class CacheStore: @unchecked Sendable {
    ...
    func readSyncState() -> SyncState? {
        ...
        return try? SportivistaJSON.decoder.decode(SyncState.self, from: data)
    }
