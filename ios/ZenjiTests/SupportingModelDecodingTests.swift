...
final class SupportingModelDecodingTests: XCTestCase {
    ...
    func testManifestDecodes() throws {
        let manifest = try ZenjiJSON.decoder.decode(Manifest.self, from: Fixture.data("manifest"))
    ...
    func testTrackedConfigDecodes() throws {
        let tracked = try ZenjiJSON.decoder.decode(TrackedConfig.self, from: Fixture.data("tracked"))
