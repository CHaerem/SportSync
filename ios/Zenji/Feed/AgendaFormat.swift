...
//  AgendaViewModel (Zenji/Agenda/) AND the widget's WidgetTimelineBuilder
//  (Zenji/Widget/). Lives in Feed/ (not Agenda/) deliberately: it has no
//  SwiftUI dependency and both the app AND the widget extension need it, and
//  ZenjiWidgetExtension's project.yml sources already include the whole
