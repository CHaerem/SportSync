...
//  `TimelineEntry`/`Timeline<Entry>` wrapping happens in ZenjiWidget.swift,
...
//  ZenjiTests bundle with no widget extension host needed.
//
...
//  widget's `getTimeline` in ZenjiWidget.swift never calls SyncClient, only
