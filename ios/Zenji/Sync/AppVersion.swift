...
/// into ZenjiTests) so it is unit-testable; the Bundle-reading glue in
...
enum AppVersionCheck {
    ...
    static var bundleStamp: String {
        (Bundle.main.object(forInfoDictionaryKey: "ZenjiBuildStamp") as? String) ?? "ukjent"
    }

    static var bundleDate: String {
        (Bundle.main.object(forInfoDictionaryKey: "ZenjiBuildDate") as? String) ?? ""
    }
