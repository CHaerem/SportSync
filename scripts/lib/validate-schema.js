// Tiny, dependency-free JSON-Schema validator. Supports exactly the keywords
// interests.schema.json uses: type, required, properties, additionalProperties:false,
// items, enum, minimum, anyOf, and local $ref (#/definitions/x). Returns error strings.
